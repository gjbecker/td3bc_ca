...
if __name__ == "__main__":
	...
	parser.add_argument("--env", default="4_agent_29_actions")        # OpenAI gym environment name
	...
	file_name = f"{args.policy}_{args.env}_{args.dataset}"
	print("----------------------------------------------------------")
	print(f"Policy: {args.policy}, Env: {args.env}, Dataset: {args.dataset}")
	print("----------------------------------------------------------")
	...
	dataset = replay_buffer.load_dataset(f'../gym_ca/GA3C/{args.env}/{args.dataset}.hdf5')
	print(dataset.keys())
	assert(0)
